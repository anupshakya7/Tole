				...
				<div class="navbar-header">
					...
					<div class="d-flex align-items-center">
						@php 
							...
							$allsurvey = \App\MedicalSurvey::where('user_id',\Auth::user()->id)->count();
							$currsurvey = \App\MedicalSurvey::where([['user_id',$user]])->whereDate('created_at',$today)->count();
						@endphp
						
						<div class="ms-1 header-item d-sm-flex">
							 <a class="btn btn-warning btn-sm">आजको वितरण </a>
							<span class="topbar-badge translate-middle badge rounded-pill bg-info">{{$currsurvey}}</span>
						</div>
						
						<div class="ms-1 header-item d-sm-flex">
							 <a href="{{route('admin.cbinsurvey.index')}}" class="btn btn-warning btn-sm">कुल गरिएको मेडिकल सर्वेक्षण </a>
							<span class="topbar-badge translate-middle badge rounded-pill bg-info">{{$allsurvey}}</span>
						</div>
						{{--<div class="ms-1 header-item d-sm-flex">
							 <a class="btn btn-warning btn-sm">आजको  मेडिकल सर्वेक्षण नम्बर </a>
							<span class="topbar-badge translate-middle badge rounded-pill bg-info">{{$currsurvey}}</span>
						</div>
						
						<div class="ms-1 header-item d-sm-flex">
							 <a href="{{route('admin.cbinsurvey.index')}}" class="btn btn-warning btn-sm">कुल मेडिकल सर्वेक्षण</a>
							<span class="topbar-badge translate-middle badge rounded-pill bg-info">{{$allsurvey}}</span>
						</div>--}}
						...
						<div class="ms-1 header-item d-sm-flex">
							<a class="btn btn-soft-success" href="{{ route('admin.medsurvey.create') }}">
								<i class="ri-add-circle-line align-middle me-1"></i> {{ 'मेडिकल वितरण थप्नुहोस्' }}
							</a>
						</div>
