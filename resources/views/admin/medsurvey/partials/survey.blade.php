			...
			<div class="row">
				...
				<div class="col-6 form-group form-check chronic_disease_name">
					...
					<select class="form-select " name="chronic_disease_name[]" multiple="multiple">
						...
						<option value="थाइरोइड">थाइरोइड</option>
						<option value="क्यान्सर">क्यान्सर</option>
						<option value="पक्षाघात">पक्षाघात</option>
						<option value="मृगौला डायलाइसिस">मृगौला डायलाइसिस</option>
				...
				<div class="col-6 form-group form-check rnot_chosing_ward">
					...
					<select id="rnot_chosing_ward" name="rnot_chosing_ward" class="form-control form-select">
						...
						<option value="सम्पूर्ण सेवा उपलब्ध नभएर">सम्पूर्ण सेवा उपलब्ध नभएर</option>
						...
						<div class="clone-item employee-info-wrap">
							<div class="row">
								...
								<div class="col-6 form-group mobile">
									...
									<div class="form-icon">
										<input type="text" name="elder[][member][mobile]" pattern="[9]{1}[0-9]{9}" 
       title="Mobile number starting with 9 and remaing 9 digit with 0-9" class="form-control form-control-icon" value="{{ old('mobile_no') }}">
		...
		<div class="col-12 div-header border-bottom-dashed dengue_malaria" style="padding-bottom: 15px;">
			<div class="row">
				...
				<div class="col-6 form-group form-check">
					...
					<select id="dengue_prevention" name="dengue_prevention[]" class="form-control form-select" multiple="multiple">
						<option value="">{{'चयन गर्नुहोस्'}}</option>	
