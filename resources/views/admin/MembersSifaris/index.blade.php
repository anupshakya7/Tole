				...
				<div class="card">						
					<div class="card-header border-bottom-dashed">
						<div class="row g-4 align-items-center">
							<div class="col-sm">
								<div>
									<h5 class="card-title mb-0">सदस्यहरूको सिफारिस सूची</h5>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-striped datatable datatable-memberssifaris" style="width:100%">
								<thead>
									<tr>
										<th> {{ '#' }}</th>
										<th>{{ 'सदस्यको नाम' }}</th>
...
toastr.options = {
	...
	$('.datatable-memberssifaris').DataTable( {
		processing:true,
		serverSide:true,
		ajax: "{!!route('admin.membersifaris.getmembersifaris')!!}",
		
		columns:[
			{ data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
			{data: 'members', name: 'members'},
			{data: 'abedans', name: 'abedans'},
			{data: 'sifaris_date', name: 'sifaris_date'},
