					...
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						...
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">{{ 'Add Tol'}}</li>
							</ol>
						</div>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header border-bottom-dashed">
							<h5 class="card-title mb-0">{{ 'Add Tol' }}</h5>
						</div>

						<div class="card-body">
							<form action="{{ route('admin.tol.store') }}" method="POST" enctype="multipart/form-data">
								@csrf
								<div class="row">
									<div class="col-12">
										<div class="row">
											<div class="col-md-6 form-group {{ $errors->has('address') ? 'has-error' : '' }}">
												...
												<input type="text" name="tol" class="form-control" value="{{ old('tol') }}" required>
												@if($errors->has('tol'))
											...
											<div class="col-md-6 form-group {{ $errors->has('tol_np') ? 'has-error' : '' }}">
												...
												<input type="text" id="tol_np" name="tol_np" class="form-control" value="{{ old('tol_np') }}" required>
