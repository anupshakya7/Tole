									...
									<div class="col-12">
										<div class="row">
											<div class="col-md-6 form-group {{ $errors->has('address') ? 'has-error' : '' }}">
												...
												<input type="text" name="address" class="form-control" value="{{ old('address', isset($address) ? $address->address : '') }}" required>
											...
											<div class="col-md-6 form-group {{ $errors->has('owner') ? 'has-error' : '' }}">
												...
												<input type="text" id="address_np" name="address_np" class="form-control" value="{{ old('address', isset($address) ? $address->address_np : '') }}">
