					...
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						...
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">{{ 'कार्यक्रम थप्नुहोस्'}}</li>
							</ol>
						</div>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header border-bottom-dashed">
							<h5 class="card-title mb-0">{{ 'कार्यक्रम थप्नुहोस्' }}</h5>
						</div>
									...
									<div class="col-12">
										<div class="row">
											<div class="col-md-6 form-group {{ $errors->has('title_en') ? 'has-error' : '' }}">
												<label for="title_en"><span class="fi fi-us fis"></span> {{ 'Title' }} <span style="color:red;">*</span></label>
											...
											<div class="col-md-6 form-group {{ $errors->has('title_np') ? 'has-error' : '' }}">
												...
												<input type="text" id="title_np" name="title_np" class="form-control" value="{{ old('title_np') }}">
											...
											<div class="col-md-6 form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
												<label for="quantity"> {{ 'मात्रा' }} <span style="color:red;">*</span></label>
