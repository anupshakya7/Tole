			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0">{{$abeden->title}} ढाँचा</h4>

						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								<li class="breadcrumb-item"><a href="{{route('admin.home')}}">वडा सर्वेक्षण</a></li>
								<li class="breadcrumb-item active">{{$abeden->title.'ढाँचा अपडेट गर्नुहोस्'}}</li>
							</ol>
						</div>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header border-bottom-dashed">
							<h5 class="card-title mb-0">{{$abeden->title.'ढाँचा अपडेट गर्नुहोस्'}}</h5>
						</div>

						<div class="card-body">
							<form action="{{ route('admin.abeden.update',$abeden->id) }}" method="POST" enctype="multipart/form-data">
										@csrf
										@method('patch')
								<div class="row">
									<div class="col-md-8">
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													...
													<input type="text" name="title" class="form-control" value="{{ old('title',$abeden->title) }}" required>
													@if($errors->has('title'))
											...
											<div class="col-12">
												<div class="form-group">
													...
													<input type="text" name="title_en" class="form-control" value="{{ old('title_en',$abeden->title_en) }}" required>
											...
											<div class="col-12">
												<div class="form-group">
													...
													<textarea name="abeden_en" id="abedenen" class="trumbowyg-textarea">{{ old('nibedan_en', $abeden->nibedan_en) }}</textarea>
												</div>
											</div>
											<div class="col-12">
												<div class="form-group">
													<label class="control-label" for="abeden" style="margin-top:15px;">निबेदन</label>
													<textarea name="abeden" id="abeden" class="trumbowyg-textarea">{{ old('abeden', $abeden->abeden) }}</textarea>
												</div>
											</div>
											<div class="col-12">
												<div class="form-group">
													<label class="control-label" for="sifaris" style="margin-top:15px;">सिफारिस(En)</label>
													<textarea name="sifaris_en" id="sifarisen" class="trumbowyg-textarea">{{ old('sifaris_en', $abeden->sifaris_en) }}</textarea>
												</div>
											</div>
											<div class="col-12">
												<div class="form-group">
													<label class="control-label" for="sifaris" style="margin-top:15px;">सिफारिस</label>
													<textarea name="sifaris" id="sifaris" class="trumbowyg-textarea">{{ old('sifaris', $abeden->sifaris) }}</textarea>
												</div>
											</div>
											<div class="col-12">
												<div class="form-group">
													<label class="control-label" for="required_docs" style="margin-top:15px;">आवश्यक कागजातहरू</label>
													<textarea name="required_docs" id="required_docs" class="trumbowyg-textarea">{{ old('required_docs', $abeden->required_docs) }}</textarea>
												</div>
											</div>
										</div>
											...
											<div class="col-12" style="margin-top:30px;">
												<div class="form-group">											
													<div class="form-check form-switch form-switch-md form-switch-success">
														<input class="form-check-input statuschng" name="status" type="checkbox" {{ $abeden->status=="1" ? "checked" : "" }}>
