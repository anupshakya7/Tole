				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title mb-0">{{'सदस्य थप्नुहोस्'}}</h4>
						</div><!-- end card header -->
						<div class="card-body">
									...
									<div class="tab-pane fade" id="steparrow-education-info" role="tabpanel" aria-labelledby="steparrow-education-info-tab">
										<div>
											<div class="mb-3">
												...
												<div class="form-icon">
													<select name="last_qualification" class="form-select form-control-icon">
													...
													<div class="clone-item employee-info-wrap">
														<div class="row">
															<div class="form-group col-4">
																...
																<div class="form-icon">
																	<select name="doc_type[]" class="form-select form-control-icon"> 
															...
															<div class="form-group col-md-4">
																...
																<input name="doc_number[]" type="text" class="form-control">
															</div>
															<div class="form-group col-md-4">
