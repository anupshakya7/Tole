							...
							<div class="h-100">
									...
									<div class="col-12">
										<div class="d-flex align-items-lg-center flex-lg-row flex-column">
											<div class="flex-grow-1">
												<h4 class="fs-16 mb-1">कम्पोस्टबिन निरीक्षण ड्यासबोर्ड</h4>
												<p class="text-muted mb-0">कम्पोस्टबिन निरीक्षण सम्बन्धि रिपोर्ट।</p>
											</div>
									...
									<div class="col-12">
										<div class="card">
												<div class="card-header border-bottom-dashed align-items-center d-flex">
														<h4 class="card-title mb-0 flex-grow-1">प्रयोगकर्ताद्वारा गरिएको कुल निरीक्षण</h4>
												</div><!-- end card header -->      
								...
								<div class="row">	
									<div class="col-6">
										<div class="card">
												<div class="card-header border-bottom-dashed align-items-center d-flex">
														<h4 class="card-title mb-0 flex-grow-1">टोल अनुसार निरीक्षण</h4>
												</div><!-- end card header -->      
												<div class="card-body p-0 pb-2">
									...
									<div class="col-6">
										<div class="card">
												<div class="card-header border-bottom-dashed align-items-center d-flex">
														<h4 class="card-title mb-0 flex-grow-1">स्थान अनुसार निरीक्षण</h4>
												</div><!-- end card header -->      
												<div class="card-body p-0 pb-2">
									...
									<div class="col-12">
										<div class="card">
												<div class="card-header border-bottom-dashed align-items-center d-flex">
														<h4 class="card-title mb-0 flex-grow-1">मिति अनुसार निरीक्षण</h4>
												</div><!-- end card header -->      
												<div class="card-body p-0 pb-2">
