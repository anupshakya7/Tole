			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0">{{$program->title_np."को वितरण कार्यक्रम"}}</h4>

						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								<li class="breadcrumb-item"><a href="{{route('admin.home')}}">वडा सर्वेक्षण</a></li>
								<li class="breadcrumb-item active">{{$program->title_np."को वितरण कार्यक्रम"}}</li>
							</ol>
						</div>
					...
					<div class="card">
						<div class="card-header border-bottom-dashed">
							<div class="row g-4 align-items-center">
								<div class="col-sm">
									<div>
										<h5 class="card-title mb-0">{{$program->title_np}} वितरण कार्यक्रमको सूची</h5>
									</div>
								</div>
...
<script>
	...
	var distributions = $('.datatable-Distribution').DataTable( {
		...
		serverSide:true,
			ajax: {
				url :   "{!!route('admin.distribution.getdistributions',$program->id)!!}",
				data: function(d){
		...
		columns:[
			...
			{data: 'programs', name: 'programs',orderable: false, searchable: false},
