							...
							<form name="compostbinsurvey" action="{{ route('admin.cbinsurvey.saved') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-6 form-group form-check">
										<label>{{ 'घर नं.' }}*</label>
										<input type="text" id="houseno"  onfocusout="getRoad();" name="house_no" class="form-control" value="{{ old('house_no') }}" required>										
									...
									<div class="col-6 form-group form-check {{ $errors->has('contact') ? 'has-error' : '' }}">
										...
										<input type="text" id="contact" name="contact" class="form-control" maxlength="10" value="{{ old('contact') }}" required>
									...
									<div class="col-6 listradio form-group {{ $errors->has('compostbin_usage') ? 'has-error' : '' }}">
										...
										<label for="compostbin_usage1" class="radio-inline">
												<input class="form-check-input" type="radio" name="compostbin_usage" id="compostbin_usage1" value="0" required>
												{{ 'छ' }}
											</label>
											
											<label for="compostbin_usage2" class="radio-inline">
												<input class="form-check-input" type="radio" name="compostbin_usage" id="compostbin_usage2" value="1"> 
												{{ 'छैन ' }}
											</label>
									...
									<div class="col-6 listradio seperated form-group {{ $errors->has('compostbin_seperated') ? 'has-error' : '' }}">
										<label for="slug">{{ 'फोहोर बर्गिकरण' }}</label><br>
											...
											<label for="compostbin_seperated1" class="radio-inline">
												<input class="form-check-input cbinseperated" type="radio" name="compostbin_seperated" id="compostbin_seperated1" value="0" required> 
												{{ 'छ' }}
											</label>

											<label for="compostbin_seperated2" class="radio-inline">
												<input class="form-check-input cbinseperated" type="radio" name="compostbin_seperated" id="compostbin_seperated2" value="1" >
												{{ 'छैन ' }}
											</label>
									...
									<div class="col-6 listradio source form-group {{ $errors->has('compostbin_source') ? 'has-error' : '' }}" style="display:none;">
										<label for="slug">{{ 'कम्पोस्टबिनको स्रोत' }}</label><br>
												
										<label for="compostbin_source1" class="radio-inline">
											<input class="form-check-input csource" type="radio" id="compostbin_source1" name="compostbin_source" value="व्यक्तिगत">
											{{ 'व्यक्तिगत' }}
										</label>
										
										<label for="compostbin_source2" class="radio-inline">
											<input class="form-check-input csource" type="radio" id="compostbin_source2" name="compostbin_source" value="वडा"> 
											{{ 'वडा ' }}
										</label>

										<label for="compostbin_source3" class="radio-inline">
											<input class="form-check-input csource" type="radio" id="compostbin_source3" name="compostbin_source" value="उपलब्ध छैन"> 
											{{ 'उपलब्ध छैन ' }}
										</label>
									...
									<div class="col-6 listradio reason form-group {{ $errors->has('reason') ? 'has-error' : '' }}" style="display:none;">
										<label for="slug">{{ 'नगर्नुको कारण' }}</label><br>
										
										<label for="reason1" class="radio-inline">
											<input class="form-check-input remark" type="radio" name="reason" id="reason1" value="समय को आभाब"> 
											{{ 'समय को आभाब' }}
										</label>

										<label for="reason2" class="radio-inline">
											<input class="form-check-input remark" type="radio" name="reason" id="reason2" value="ठाउँको अभाव" >
											{{ 'ठाउँको अभाव ' }}
										</label>

										<label for="reason" class="radio-inline">
											<input class="form-check-input remark" type="radio" name="reason" id="formradioRight5" value="अन्य" >
											{{ 'अन्य' }}
										</label>
