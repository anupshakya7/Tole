				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title mb-0">{{'सदस्य दर्ता गर्नुहोस'}}</h4>
						</div><!-- end card header -->
						<div class="card-body">
							<form id="memberform" action="{{route('member-store')}}" class="form-steps" autocomplete="off" method="POST" enctype="multipart/form-data">
								@csrf
